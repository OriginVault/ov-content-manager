...
export class StorageService {
     ...
     */
    async createStorageAssertion(storageDid, assertion) {
        try {
            if (!parentStore.agent) {
                throw new Error('DID agent not available');
            }
     ...
     */
    async ensureAnonymousStorageDid() {
        try {
     ...
     */
    async createProofOfUpload(storageDid, snowflake, mnemonicId, contentHash, fileName, size, mimeType, uploaderIpHash, manifestRef, manifestMnemonicId) {
        try {
            if (!parentStore.agent) {
                throw new Error('DID agent not available');
            }
