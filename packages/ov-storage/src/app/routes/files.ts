...
import { identityPathByContentHash, putJson } from "../identityStore.js";
...
export function buildFileRoutes(): Router {
  const router = Router();
  ...
  router.post("/request-upload-url", requireAuth as any, uploadLimiter, async (req: Request, res: Response): Promise<void> => {
  ...
  router.post("/upload", requireAuth as any, uploadLimiter, upload.single("file"), async (req: Request, res: Response): Promise<void> => {
    try {
  ...
  router.post("/upload-authenticated", requireAuth as any, uploadLimiter, upload.single("file"), async (req: Request, res: Response): Promise<void> => {
    try {
      const file = req.file;
      if (!file) {
  ...
  router.post("/claim-storage-did", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    try {
      const auth = (req as any).auth;
      if (!auth || !auth.sub) {
        res.status(401).json({ error: "User not authenticated" });
  ...
  router.get("/identity/:contentHash", async (req: Request, res: Response): Promise<void> => {
  ...
  router.post("/check-file-uploaded", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  router.post("/request-public-upload-url", requireAuth as any, uploadLimiter, async (req: Request, res: Response): Promise<void> => {
  ...
  router.post("/publish-private-file", requireAuth as any, uploadLimiter, async (req: Request, res: Response): Promise<void> => {
  ...
  router.post("/get-file-by-mnemonic", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  router.post("/get-public-file-by-mnemonic", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  router.get("/list-user-files/:userDID", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  // List public files
  router.get("/list-public-files", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    const fileList: any[] = [];
    try {
  ...
  router.delete("/delete-upload/:userDID/:fileId", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      ...
      for await (const obj of stream as any) {
        if (obj.name.includes(fileId)) objectsToDelete.push(obj.name);
      }
  ...
  router.delete("/delete-manifest/:userDID/:manifestId", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  router.delete("/delete-public-manifest/:username/:manifestId", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  router.get("/list_signed_user_files", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    try {
      const auth = (req as any).auth;
      if (!auth || !auth.sub) {
        res.status(401).json({ error: "User not authenticated" });
  ...
  router.get("/get_user_public_files/:username", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
  ...
  router.get("/user_upload_count/:userDID", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    const { userDID } = req.params;
  ...
  router.get("/get_signed_user_file/:userDID/:fileId", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    const { userDID, fileId } = req.params;
  ...
  router.post("/save_user_manifest_draft", requireAuth as any, async (req: Request, res: Response): Promise<void> => {
    try {
      const auth = (req as any).auth;
      if (!auth || !auth.sub) {
        res.status(401).json({ error: "User not authenticated" });
      ...
      await minioClient.putObject(
        BUCKET,
        draftPath,
        Buffer.from(JSON.stringify(draftManifest, null, 2)),
        undefined,
        {
          "Content-Type": "application/json",
