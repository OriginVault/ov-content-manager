...
export async function createApp() {
  ...
  app.use('/files', userRateLimit as any);
  app.use('/anonymous', ipRateLimit as any);
  app.use('/bucket', userRateLimit as any);
  app.use('/storage', userRateLimit as any);
  app.use('/manifests', userRateLimit as any);
