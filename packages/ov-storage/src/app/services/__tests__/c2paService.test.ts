import { C2PAService, C2PA_SUPPORTED_TYPES } from "../c2paService.js";
...
jest.mock("c2pa-node", () => ({
  ...
  ManifestBuilder: jest.fn().mockImplementation((options) => ({
    ...options,
    addAction: jest.fn(),
...
describe("C2PA Service", () => {
  ...
  describe("getSupportedTypes", () => {
    it("should return all supported types", () => {
      ...
      expect(supportedTypes).toHaveLength(Object.keys(C2PA_SUPPORTED_TYPES).length);
  ...
  describe("generateManifest", () => {
    ...
    it("should generate manifest for supported file type", async () => {
      const result = await c2paService.generateManifest(mockFileBuffer, mockOptions);
    ...
    it("should generate manifest for anonymous upload", async () => {
      ...
      const result = await c2paService.generateManifest(mockFileBuffer, anonymousOptions);
    ...
    it("should fail for unsupported file type", async () => {
      ...
      const result = await c2paService.generateManifest(mockFileBuffer, unsupportedOptions);
    ...
    it("should handle errors during manifest generation", async () => {
  ...
  describe("signFile", () => {
    ...
    it("should sign file successfully", async () => {
      ...
      const testC2paService = new C2PAService();
      const result = await testC2paService.signFile(mockFileBuffer, "image/jpeg", mockManifest);
  ...
  describe("readManifest", () => {
    ...
    it("should read manifest successfully", async () => {
      const { createC2pa } = require("c2pa-node");
      const mockC2pa = {
      ...
      // Create a new instance to use the mocked c2pa
      const testC2paService = new C2PAService();
      const result = await testC2paService.readManifest(mockFileBuffer, "image/jpeg");
