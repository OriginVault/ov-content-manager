...
import { provisionSandboxCert } from "./sslSigner.js";
...
export class C2PA {
    ...
    signer;
    certConfig;
    initializedWithSsl = false;
    constructor(signerOrConfig) {
...
export function createC2paClient(signerOrConfig) {
    return new C2PA(signerOrConfig);
}
function isCertConfig(v) {
